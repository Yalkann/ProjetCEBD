...
#3.3 : Ajouter les éléments nécessaires pour créer le trigger (attention, syntaxe SQLite différent qu'Oracle)
def updateDBfileTrigger(data:sqlite3.Connection, file):
