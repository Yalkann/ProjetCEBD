...
class AppFctDev1Partie3(QDialog):
    ...
    def __init__(self, data: sqlite3.Connection):
        ...
        self.ui = uic.loadUi("gui/v1_fct_dev_1_3.ui", self)
        self.data = data
    ...
    def refreshResultDev3(self):
        display.refreshLabel(self.ui.label_dev_1_3, "")
        if not self.ui.lineEditDev3.currentText():
            self.ui.tableDev_1_3.setRowCount(0)
            display.refreshLabel(self.ui.label_dev_1_3, "Veuillez indiquer un nom de catégorie")
        else:
            try:
                cursor = self.data.cursor()
                ...
                self.ui.tableDev_1_3.setRowCount(0)
                display.refreshLabel(self.ui.label_dev_1_3, "Impossible d'afficher les résultats : " + repr(e))
            else:
                i = display.refreshGenericData(self.ui.tableDev_1_3, result)
                if i == 0:
                    display.refreshLabel(self.ui.label_dev_1_3, "Aucun résultat")

    def refreshDev1Partie3(self):

        self.refreshTable(self.ui.label_dev_1_3, self.ui.tableDev_1_3,
                          "")
